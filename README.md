...
![[模板及项目/image/License-MIT-blue.svg]]
...
#### 3. 数据连接建立（PORT 主动模式）
https://github.com/SuzukiTccy/QTProject-FTP/blob/master/image/server3.svg
...
#### 1. 连接与登录流程
https://github.com/SuzukiTccy/QTProject-FTP/blob/master/image/client1.svg

#### 2. 文件下载（支持断点续传）
https://github.com/SuzukiTccy/QTProject-FTP/blob/master/image/client2.svg

#### 3. 暂停/恢复传输
https://github.com/SuzukiTccy/QTProject-FTP/blob/master/image/client3.svg
